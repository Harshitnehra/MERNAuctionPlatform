...
const AuctionItem = () => {
  ...
  const showCurrentBid = auctionEnded || timeRemaining > 1440;
  ...
  return (
    <section className="max-w-4xl mx-auto my-10 p-6 bg-white shadow-lg rounded-lg">
      ...
      <div className="flex justify-between items-center my-6">
        ...
        >
          <FaTrophy className="text-2xl" /> Leaderboard
        </Link>
      </div>
        ...
        <div className="col-span-2 bg-gray-50 p-6 rounded-lg shadow">
          ...
          {showCurrentBid ? (
            ...
            <p className="text-lg font-semibold text-red-500">
              ⚠ Current bid is hidden one day before auction ends.
            </p>
          )}
      ...
      {user?.role === "Bidder" && !auctionEnded ? (
        <div className="mt-8 p-6 bg-white shadow-lg rounded-lg">
          <h2 className="text-xl font-semibold text-orange-500">Place a Bid</h2>
          <div className="mt-4">
            <input
              type="number"
              value={amount}
            ...
            <button
              onClick={handleBid}
              className="mt-4 w-full bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold py-3 rounded-lg hover:shadow-lg transition-all duration-300"
            >
              Place Bid
            </button>
          </div>
